...
- read and summarize the Lab 1 labsheet requirements;
...
The important constraints supplied to the assistant were:

1. create all four Issues before implementation;
2. use main as stable, lab1-staging as integration, and one feature branch per Issue;
3. require peer review for every Pull Request;
4. record AI use and reviewer evidence in docs/lab-01/.

The final code and the review workflow remain the responsibility of the student.
